...
function showUserForm(itemQty) {
  ...
  <h3 class="egys-payment-title">Which payment method would you prefer?</h3>
  ...
  <div class="egys-payment-method">
    ...
    <label for="egys-vodafone" class="egys-payment-label">
      <img src="https://upload.wikimedia.org/wikipedia/commons/9/95/Vodafone_logo_2017.png" alt="Vodafone Cash" class="egys-payment-icon">
